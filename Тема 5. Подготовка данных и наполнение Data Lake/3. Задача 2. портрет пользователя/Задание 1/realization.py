...
def input_paths(date, depth):
    ...
    for i in range(depth):
        ...
        path_message = f'/user/vyushmanov/data/events/date={start_date}/event_type=message'
        path_reactions = f'/user/vyushmanov/data/events/date={start_date}/event_type=reaction'
        path_list_message.append(f'{host}{path_message}')
        path_list_reactions.append(f'{host}{path_reactions}')
    return path_list_message, path_list_reactions


def calculate_user_interests(date, depth, spark):
    path_messages, path_reactions = input_paths(date, depth)

    df_messages = spark.read.parquet(*path_messages)
